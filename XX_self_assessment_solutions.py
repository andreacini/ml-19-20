...
# 2.
b = A.reshape(-1)
print("shape of b:", b.shape)  # This should be equal to 49 = 5*9 
b_mean = b.mean()
print("mean of b:", b_mean)  # This should be approximately 1.5
b_var = b.var()
print("var of b:", b_var)  # This should be approximately 0.04 = 0.2**2 
# 3.
C = A.dot(A.T)
# 4.
C_diag = np.diag(C)
...
lam = eigval
# 8. it should be equal to C_tr
print("sum eigval:", lam.sum())
# 9. it should be equal to C_det
print("prod eigval:", lam.prod())
# 10.
U = eigvec
# 11.
L = np.diag(lam)
